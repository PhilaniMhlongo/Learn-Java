...
public class LowestCommonAncestorTest {
  ...
  private TreeNode createFirstTreeFromSlides() {
    ...
    return com.williamfiset.algorithms.graphtheory.treealgorithms.LowestCommonAncestor.TreeNode.rootTree(tree, 0);
  }

  @Test
  public void testLcaTreeFromSlides1() {
    TreeNode root = createFirstTreeFromSlides();
    com.williamfiset.algorithms.graphtheory.treealgorithms.LowestCommonAncestor solver = new com.williamfiset.algorithms.graphtheory.treealgorithms.LowestCommonAncestor(root);
